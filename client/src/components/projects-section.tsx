...
const projects = [
  {
    ...
    problem: "Users struggled with product discovery and checkout process in existing e-commerce apps.",
    ...
    outcome: "40% increase in conversion rate and 60% reduction in cart abandonment.",
  ...
  },
  {
    ...
    problem: "Complex financial data visualization overwhelming users and poor information hierarchy.",
    process: ["Analytics Review", "Information Architecture", "UI Design", "A/B Testing"],
    tools: [
      { name: "Figma", color: "blue" },
      { name: "Adobe XD", color: "red" },
      { name: "Hotjar", color: "yellow" }
    ],
    outcome: "50% faster task completion and 35% increase in user satisfaction scores.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explore my recent work where I've solved complex user problems through research-driven design solutions.
          </p>
        </motion.div>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <p className="text-sm font-medium text-dark mb-2">UX Process:</p>
                ...
                <div className="mb-4">
                  <p className="text-sm font-medium text-dark mb-2">Tools Used:</p>
                  <div className="flex flex-wrap gap-2">
                    {project.tools.map((tool) => (
                      <Badge key={tool.name} className={`text-xs ${getColorClasses(tool.color)}`}>
                        {tool.name}
                      </Badge>
                    ))}
                  </div>
