...
const contactInfo = [
  {
    icon: Mail,
    title: "Email",
    value: "sudhakar@example.com",
    href: "mailto:sudhakar@example.com",
    color: "primary"
  },
  {
    icon: Linkedin,
    title: "LinkedIn",
    value: "linkedin.com/in/sudhakar-ux",
    href: "https://linkedin.com/in/sudhakar-ux",
    color: "secondary"
  },
  {
    icon: Instagram,
    title: "Instagram",
    value: "@sudhakar_designs",
    href: "https://instagram.com/sudhakar_designs",
    color: "accent"
  }
];
...
export default function ContactSection() {
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      case "primary": return "bg-primary/10 text-primary hover:text-primary/80";
      case "secondary": return "bg-secondary/10 text-secondary hover:text-secondary/80";
      case "accent": return "bg-accent/10 text-accent hover:text-accent/80";
      default: return "bg-primary/10 text-primary hover:text-primary/80";
    }
  };
  ...
  return (
    <section id="contact" className="py-20 bg-light">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-dark mb-4">Let's Work Together</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
              ...
              {contactInfo.map((info) => {
                ...
                return (
                  <div key={info.title} className="flex items-center">
                    <div className={`w-12 h-12 ${getColorClasses(info.color).split(' ')[0]} ${getColorClasses(info.color).split(' ')[1]} rounded-xl flex items-center justify-center mr-4`}>
            ...
            <div className="mt-12">
              <h4 className="font-semibold text-dark mb-4">Why Work With Me?</h4>
          ...
          >
            <h3 className="text-2xl font-semibold text-dark mb-6">Send Message</h3>
            <Form {...form}>
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value || ""}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="consultation">UX Consultation</SelectItem>
